                    ...
                    <div class="p-archive__tab">
                        <nav>
                            <ul class="p-archive__list">
                                <li class="p-archive__list-item -current"><a href="<?php echo esc_url( home_url("/all/")); ?>">すべて</a></li>
                                <li class="p-archive__list-item"><a href="<?php echo esc_url( home_url("/information/")); ?>">お知らせ</a></li> 
                                <li class="p-archive__list-item"><a href="<?php echo esc_url( home_url("/column/")); ?>">コラム</a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
